...
GitHub Actions 计划**每 4 小时**在第 **17 分钟（UTC）**尝试获取一次完整响应，校验后提交。
...
因此每 4 小时计划采集、实际推送成功和某地 CDN 可见是不同时间，不承诺严格准点或全网同时刷新。

建议消费端每 10–15 分钟加随机偏移检查索引；12 小时可提示陈旧，24 小时可提示严重陈旧，
